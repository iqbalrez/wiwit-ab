                ...
                <form action="{{ route('admin.work.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <x-input id="title" type="text" label="Title" required name="title" value=""
                            placeholder="" class="" />
                        <x-input id="date" type="date" label="Date" required name="date" value=""
                            placeholder="" class="" />
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#default-modal form #photo').after(
                            `<a href="{{ asset('storage/works/${data.photo}') }}" target="_blank" class="text-blue-500">Lihat Thumbnail</a>`
                        );
                    },
                    error: function() {
                        Swal.fire(
