<x-app-layout>
                    ...
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-6 py-4 space-x-3">
                            ...
                            <ion-icon name="trash-bin" class="w-6 h-6 text-red-600 cursor-pointer"
                                ...
                                onclick="$('#popup-modal form').attr('action', '{{ route('admin.material.destroy', $data->id) }}')"></ion-icon>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    @push('js-internal')
        <script>
            ...
            function btnEdit(id) {
                let url = "{{ route('admin.material.update', ':id') }}";
                url = url.replace(':id', id);
                $.ajax({
                    url: "{{ route('admin.material.show', ':id') }}".replace(':id', id),
                    type: "GET",
                    dataType: "JSON",
