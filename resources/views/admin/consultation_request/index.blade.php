<x-app-layout>
    <div class="relative overflow-x-auto rounded-lg custom-box-shadow">
        ...
        <table class="w-full text-sm text-left text-gray-500 ">
            ...
            <tbody>
                @foreach ($consultationRequests as $data)
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <form action="{{ route('admin.consultation-request.store') }}" method="POST"
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <x-input id="email" type="text" label="Email" required name="email"
                            value="" placeholder="" class="" />
                        <x-input id="subject" type="text" label="Subject" required name="subject"
                            value="" placeholder="" class="" />
                        <x-input id="message" type="text" label="Message" required name="message"
                            value="" placeholder="" class="" />
                    </div>
                    <!-- Modal footer -->
    ...
    @push('js-internal')
        <script>
            function btnAdd() {
                ...
                let url = "{{ route('admin.consultation-request.store') }}";
