<x-guest-layout>
    ...
    <section>
        ...
        <section class="max-w-4xl mx-auto">
            ...
            <div class="max-w-4xl mx-auto px-8 mt-4">
            ...
            <div
                class="mb-8 md:mb-14 flex items-center justify-center px-8 w-full mt-6 mx-auto md:px-12 lg:px-14 xl:px-0 max-w-4xl">
